...
import ShoppingConfirmation from './modules/shopping/ShoppingConfirmation';
...
function AppContent() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('offers-open', handler as EventListener);
  }, [setCurrentPage]);
  ...
  if (!localStorage.getItem('allProducts')) {
    try {
      const defaultProducts = [
        { id: '1', name: 'Apple iPhone 15 Pro', category: 'Electronics', price: 129900, image: 'https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg?auto=compress&cs=tinysrgb&w=600', description: 'Latest Apple iPhone with A17 chip, Pro camera and Dynamic Island' },
        { id: '2', name: 'Sony WH-1000XM5 Headphones', category: 'Audio', price: 29990, image: 'https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=600', description: 'Industry-leading noise cancellation with premium sound' },
        { id: '3', name: 'Nike Air Max Sneakers', category: 'Fashion', price: 8999, image: 'https://images.pexels.com/photos/1598505/pexels-photo-1598505.jpeg?auto=compress&cs=tinysrgb&w=600', description: 'Comfortable running shoes with responsive cushioning' },
        { id: '4', name: 'Samsung 55" 4K Smart TV', category: 'Electronics', price: 54990, image: 'https://images.pexels.com/photos/1201996/pexels-photo-1201996.jpeg?auto=compress&cs=tinysrgb&w=600', description: 'Ultra HD display with HDR10+ and smart apps' },
        { id: '5', name: "Levi's Denim Jacket", category: 'Fashion', price: 3499, image: 'https://images.pexels.com/photos/1058959/pexels-photo-1058959.jpeg?auto=compress&cs=tinysrgb&w=600', description: 'Classic denim jacket with a modern fit' },
        { id: '6', name: 'Apple MacBook Air M2', category: 'Computers', price: 119900, image: 'https://images.pexels.com/photos/18105/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=600', description: 'Lightweight laptop with M2 performance and long battery life' }
      ];
  ...
  if (!localStorage.getItem('allRestaurants')) {
    try {
      const defaultRestaurants = [
        { id: '1', name: 'Punjabi Dhaba', cuisine: 'North Indian', image: 'https://images.pexels.com/photos/1624487/pexels-photo-1624487.jpeg?auto=compress&cs=tinysrgb&w=600' },
        { id: '2', name: 'Pizza Hub', cuisine: 'Italian, Fast Food', image: 'https://images.pexels.com/photos/2147491/pexels-photo-2147491.jpeg?auto=compress&cs=tinysrgb&w=600' },
        { id: '3', name: 'South Spice', cuisine: 'South Indian', image: 'https://images.pexels.com/photos/5560763/pexels-photo-5560763.jpeg?auto=compress&cs=tinysrgb&w=600' }
      ];
      localStorage.setItem('allRestaurants', JSON.stringify(defaultRestaurants));
    } catch { /* ignore */ }
  }
  ...
  if (!localStorage.getItem('allMovies')) {
    try {
      const defaultMovies = [
        { id: '1', title: 'Avengers: Secret Wars', image: 'https://images.pexels.com/photos/7991579/pexels-photo-7991579.jpeg?auto=compress&cs=tinysrgb&w=600' },
        { id: '2', title: 'The Dark Knight Returns', image: 'https://images.pexels.com/photos/7991319/pexels-photo-7991319.jpeg?auto=compress&cs=tinysrgb&w=600' },
        { id: '3', title: 'Inception 2', image: 'https://images.pexels.com/photos/436413/pexels-photo-436413.jpeg?auto=compress&cs=tinysrgb&w=600' }
      ];
