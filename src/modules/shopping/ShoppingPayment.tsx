...
export default function ShoppingPayment() {
  ...
  const handleSuccess = (details: {
    ...
    try {
      if (details.paymentMethod === "wallet" && wallet) {
        ...
        const tx = {
          ...
          description: `Shopping Order ${newOrder.id}`,
    ...
    // Celebrate successful shopping order
    setTimeout(
      () =>
    ...
    // Go back to Shopping Home instead of a dedicated confirmation page
        ...
        <div className="mb-2 bg-white rounded-xl border border-gray-200 p-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-sm underline text-brand-700 hover:text-brand-800"
            >
              Change
            </button>
          </div>
