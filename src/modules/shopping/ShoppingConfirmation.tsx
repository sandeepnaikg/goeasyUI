    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-3xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">Your order <span className="font-semibold">{order.id}</span> is confirmed.</p>
          <div className="mb-6">
          ...
          <div className="flex justify-center space-x-4">
            <button onClick={() => setCurrentPage('shopping-tracking')} className="px-6 py-3 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-xl font-semibold">Track Order</button>
            <button onClick={handleShare} className="px-6 py-3 bg-white border rounded-xl flex items-center space-x-2"><Share2 className="w-4 h-4" /><span>Share</span></button>
          </div>
        </div>
      </div>
    </div>
